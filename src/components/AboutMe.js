...
function AboutMe() {
  return (
    ...
    <Typed 
       ...
       My clients include beauty experts, animal lovers,dogs, a koala bear, Jean-Claude Van Damme, investment experts, professional sugar babies, stockbrokers, writers, hikers, 
